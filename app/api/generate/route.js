          ...
          messages: [
            {
              role: "system",
              content:
                "You are a playlist generator. Given a description of desired music, you return a JSON object with a 'tracks' array. Each track must have 'title','artist' and 'link' fields.The link is the spotify link of each music.Maximum 10 tracks. Respond with JSON ONLY, no extra text.",
            },
            {
              role: "user",
